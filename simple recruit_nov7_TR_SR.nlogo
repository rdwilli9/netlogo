 ...
 clear-all
  ...
  crt persons / 4 [
    ...
    ifelse resist < 1
      [set size 1]
      [set size resist]
    if any? turtles-on patch-here [ move-to one-of patches in-radius village_size] ;; location of farmers: they can't be in the same patch of other turtle.
    ]
  ...
  crt co-farmers / 4 [
    ...
    ifelse reputation < 1   ;; size of co-farmers is determined by the reputation value.
      [set size 1]
      [set size reputation]
    if any? turtles-on patch-here [ move-to one-of patches in-radius village_size] ;; location of co-farmers: they can't be in the same patch of other turtle.
    ]
...
"" ""
PENS
"default" 1.0 0 -13345367 true "" "plot count turtles with [color = blue] "
...
"" ""
PENS
"default" 1.0 0 -10899396 true "" "plot count turtles with [color = green] "
