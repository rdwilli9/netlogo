...
turtles-own [
  identity-value   ;; a random value between 0 and 1
  benefits         ;; benefits percieved to be part of a coop
  costs            ;; costs of sell coffee based on distance to market
  capital          ;; a function of initial capital of coops and external investment of CI
]
...
to setup
 ...
 ask patches [                             ;; create a patch which is the market
   if pxcor = 0 and pycor = 0
    [set pcolor green]                     ;; market is a green patch
    ]
  reset-ticks
end
...
to go
  ask turtles [
  accounting                               ;; persons makes accounts
  join_coop                                ;; persons joint to coop
]
  tick
end

to accounting
 set costs distance-market                      ;; use the reporter called distance-market
  if costs <= capital                           ;; if costs are lesser or equal to your capital, you will receieve increase your identity
  [set identity-value identity-value * 0.05 ]
end
